...
def main():
    ...
    ordered_codes = load_ordered_items("../Dataverwerking_code/Dataverwerking_data_output/augmented_output.csv")  # sim_output.csv of augmented_output.csv
    ...
    tray_items, not_placed = fill_trays_by_frequency(ordered_codes, loaded, tray_width, tray_height,max_trays)
